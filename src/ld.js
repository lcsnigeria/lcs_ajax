...
const valuesPattern = `(?:${borderSettingPattern}|${gridTempPattern}|${hexColorPattern}|${digitLengthPattern}|${digitPattern}|${floatPattern}|${calcFuncPattern}|${colorFuncPattern}|${textPattern})(?:\\.(?:${borderSettingPattern}|${gridTempPattern}|${digitLengthPattern}|${digitPattern}|${floatPattern}|${calcFuncPattern}|${colorFuncPattern}|${hexColorPattern}|${textPattern}))*`;
